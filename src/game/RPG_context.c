 ...
 * @return pointer to created CONTEXT_RPG struct or NULL if some error occured while init.
 */
...
/**
 * For Destorying CONTEXT_RPG, is only called via. CONTEXT_RPGE*->fdestroyPContextPtr.
