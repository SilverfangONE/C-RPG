...
loadGame ()
{
  ...
  // load init env.
  push_ENV (game, "./res/enviroments/WORLD/OPEN_WORLD/OPEN_WORLD.json");
...
// ---- SMOKE-TESTS ----
void
smokeTestIMGRender (GameState *game)
{
  // test
  SDL_Texture *img
      = IMG_LoadTexture (game->renderer, "./res/tilesheets/Studio_Logo.png");
