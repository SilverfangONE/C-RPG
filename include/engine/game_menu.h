...
void DrawSelf_mobj (SDL_Renderer *renderer, SDL_Texture *menuTilesheet,
                    MenuObject *mobj);
...
int getID_mobj (const MenuObject *mobj);
char *getName_mobj (const MenuObject *mobj);
Vec2D getSize_mobj (const MenuObject *mobj);
bool hasChildren_mobj (const MenuObject *mobj);
